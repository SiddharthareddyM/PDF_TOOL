...
def draw_signature_window(temp_path, callback):
    ...
    tk.Button(button_frame, text="Cancel", command=cancel, bg="#6c757d", fg="white").pack(side="right", padx=10)
...
def pdf_text_position_selector(pdf_path, page_num, text, font_size):
    ...
    # Instructions
    instruction_frame = tk.Frame(pos_window, bg="#f0f0f0", pady=10)
    ...
    canvas_frame = tk.Frame(pos_window)
    canvas_frame.pack(expand=True, fill="both", padx=10, pady=5)
    
    canvas = Canvas(canvas_frame, bg="white", highlightthickness=1, highlightbackground="#ccc")
    ...
    def on_canvas_click(event):
        ...
        confirm_btn.config(state="normal", bg="#28a745")
    ...
    bottom_frame = tk.Frame(pos_window, bg="#f0f0f0", pady=10)
...
footer_label = tk.Label(footer_frame, text="PDF Toolkit v2.1 - Enhanced Text Positioning", 
                       font=("Segoe UI", 8), 
                       fg="#7f8c8d", bg="#2c3e50")
